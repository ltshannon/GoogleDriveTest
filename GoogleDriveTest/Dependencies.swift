...
extension GoogleDriveClient.Client: DependencyKey {
  public static let liveValue = Client.live(
    config: Config(
      clientID: "217682530430-ahc31nq2f2dure46os5b8d2m2oknkprd.apps.googleusercontent.com",
      authScope: "https://www.googleapis.com/auth/drive",
      redirectURI: "com.googleusercontent.apps.217682530430-ahc31nq2f2dure46os5b8d2m2oknkprd://"
    )
  )
